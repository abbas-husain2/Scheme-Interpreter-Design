...
public class MiniSchemeParser implements MiniSchemeParserConstants {
  ...
  static final public ListExpr ListExpr() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n7;
    ...
    n7 = jj_consume_token(RPAREN);
     ...
     {if (true) return new ListExpr(n0,n2,n4,n6);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public CarExpr CarExpr() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
    ...
    n6 = jj_consume_token(RPAREN);
     ...
     {if (true) return new CarExpr(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }

  static final public CdrExpr CdrExpr() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
    ...
    n6 = jj_consume_token(RPAREN);
            n5 = JTBToolkit.makeNodeToken(n6);
     {if (true) return new CdrExpr(n0,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }
